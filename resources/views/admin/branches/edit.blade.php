...
<div class="container mx-auto px-4 py-6">
    <div class="max-w-4xl mx-auto">
        <div class="flex items-center justify-between mb-6">
            <div>
                <h1 class="text-3xl font-bold text-gray-900 dark:text-white">Edit Branch</h1>
                <p class="text-gray-600 dark:text-gray-400 mt-2">{{ $branch->branch_name }} ({{ $branch->branch_code }})</p>
            </div>
            <div class="flex space-x-3">
                <a href="{{ route('admin.branches.show', $branch) }}" 
                    class="bg-blue-600 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded-lg transition-colors">
                    <i class="fas fa-eye mr-2"></i>View Branch
                </a>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="space-y-4">
                        ...
                        <div>
                            ...
                            <input type="text" name="branch_code" id="branch_code" value="{{ old('branch_code', $branch->branch_code) }}" 
                        ...
                        <div>
                            ...
                            <input type="text" name="branch_name" id="branch_name" value="{{ old('branch_name', $branch->branch_name) }}" 
                                class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-transparent dark:bg-gray-700 dark:text-white"
                        ...
                        <div>
                            ...
                            <select name="status" id="status" 
                                ...
                                @foreach($statuses as $status)
                                    <option value="{{ $status }}" {{ old('status', $branch->status) == $status ? 'selected' : '' }}>
                                        {{ ucfirst($status) }}
                                    </option>
                                @endforeach
                            </select>
                    ...
                    <div class="space-y-4">
                        ...
                        <div>
                            ...
                            <textarea name="address" id="address" rows="3" 
                                class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-transparent dark:bg-gray-700 dark:text-white"
                                placeholder="Full street address">{{ old('address', $branch->address) }}</textarea>
                            @error('address')
                                <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                            @enderror
                        </div>
                ...
                <div class="mt-8 space-y-4">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                        ...
                        <div>
                            ...
                            <input type="tel" name="manager_phone" id="manager_phone" value="{{ old('manager_phone', $branch->manager_phone) }}" 
                                class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-transparent dark:bg-gray-700 dark:text-white"
                ...
                <div class="mt-8 space-y-4">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        @php
                            ...
                            $hours = $branch->opening_hours[$dayLower] ?? null;
                            $openTime = $hours && !$hours['closed'] ? $hours['open'] : '';
                            $closeTime = $hours && !$hours['closed'] ? $hours['close'] : '';
                        @endphp
                        <div class="border border-gray-200 dark:border-gray-600 rounded-lg p-4">
                            ...
                            <div class="grid grid-cols-2 gap-3">
                                <div>
                                    ...
                                    <input type="time" name="opening_hours[{{ $dayLower }}][open]" value="{{ $openTime }}"
                                ...
                                <div>
                                    ...
                                    <input type="time" name="opening_hours[{{ $dayLower }}][close]" value="{{ $closeTime }}"
                                        class="w-full px-2 py-1 border border-gray-300 dark:border-gray-600 rounded focus:ring-2 focus:ring-purple-500 focus:border-transparent dark:bg-gray-700 dark:text-white">
                                </div>
                            </div>
                        </div>
                ...
                <div class="mt-8 space-y-4">
                    ...
                    <div>
                        ...
                        <textarea name="notes" id="notes" rows="4" 
                            class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-transparent dark:bg-gray-700 dark:text-white"
                            placeholder="Any additional information about this branch...">{{ old('notes', $branch->notes) }}</textarea>
                        @error('notes')
                            <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                        @enderror
                    </div>
