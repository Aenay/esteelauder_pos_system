...
<head>
    ...
    <title>{{ config('app.name', 'Estee Lauder POS') }} - Customer Login</title>
        ...
        <form class="mt-8 space-y-6" method="POST" action="{{ route('customer.login') }}">
            ...
            <div>
                <button type="submit" 
                    ...
                    <span class="absolute left-0 inset-y-0 flex items-center pl-3">
                        <i class="fas fa-lock text-pink-500 group-hover:text-pink-400"></i>
                    </span>
                    Sign in
                </button>
            </div>
            ...
            <div class="text-center">
                <p class="text-sm text-gray-600">
                    ...
                    <a href="{{ route('customer.register') }}" class="font-medium text-pink-600 hover:text-pink-500">
                        Register here
                    </a>
                </p>
            </div>
