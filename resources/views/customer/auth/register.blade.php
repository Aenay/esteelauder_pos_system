...
<head>
    ...
    <title>{{ config('app.name', 'Estee Lauder POS') }} - Customer Register</title>
    ...
    <div class="max-w-md w-full space-y-8">
        <div>
            ...
            <p class="mt-2 text-center text-sm text-gray-600">
                Join our loyalty program and track your orders
            </p>
        </div>
        <form class="mt-8 space-y-6" method="POST" action="{{ route('customer.register') }}">
            ...
            <div class="space-y-4">
                <div>
                    ...
                    <input id="Customer_Name" name="Customer_Name" type="text" required 
                           class="mt-1 appearance-none relative block w-full px-3 py-2 border border-gray-300 placeholder-gray-500 text-gray-900 rounded-md focus:outline-none focus:ring-pink-500 focus:border-pink-500 sm:text-sm @error('Customer_Name') border-red-500 @enderror" 
                ...
                <div>
                    ...
                    <input id="Customer_Email" name="Customer_Email" type="email" required 
                           class="mt-1 appearance-none relative block w-full px-3 py-2 border border-gray-300 placeholder-gray-500 text-gray-900 rounded-md focus:outline-none focus:ring-pink-500 focus:border-pink-500 sm:text-sm @error('Customer_Email') border-red-500 @enderror" 
                ...
                <div>
                    ...
                    <input id="Customer_Phone" name="Customer_Phone" type="tel" 
                           class="mt-1 appearance-none relative block w-full px-3 py-2 border border-gray-300 placeholder-gray-500 text-gray-900 rounded-md focus:outline-none focus:ring-pink-500 focus:border-pink-500 sm:text-sm @error('Customer_Phone') border-red-500 @enderror" 
                ...
                <div>
                    <label for="Customer_Address" class="block text-sm font-medium text-gray-700">Address (Optional)</label>
                    <textarea id="Customer_Address" name="Customer_Address" rows="3"
                              class="mt-1 appearance-none relative block w-full px-3 py-2 border border-gray-300 placeholder-gray-500 text-gray-900 rounded-md focus:outline-none focus:ring-pink-500 focus:border-pink-500 sm:text-sm @error('Customer_Address') border-red-500 @enderror" 
            ...
            <div class="text-center">
                <p class="text-sm text-gray-600">
                    ...
                    <a href="{{ route('customer.login') }}" class="font-medium text-pink-600 hover:text-pink-500">
                        Sign in here
                    </a>
                </p>
            </div>
