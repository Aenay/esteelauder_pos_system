        ...
        <div class="max-w-3xl mx-auto bg-white p-6 rounded shadow">
            <form method="POST" action="{{ route('promotions.store') }}" class="space-y-5">
                ...
                <div>
                    ...
                    <input name="Promotion_Name" class="mt-1 w-full border rounded p-2" required value="{{ old('Promotion_Name') }}">
                </div>
                <div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                    ...
                    <div>
                        ...
                        <input name="Discount_Value" type="number" step="0.01" min="0" class="mt-1 w-full border rounded p-2" required value="{{ old('Discount_Value') }}">
                    </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                        ...
                        <input name="Start_Date" type="date" class="mt-1 w-full border rounded p-2" value="{{ old('Start_Date') }}">
                    </div>
                    <div>
                        <label class="block text-sm font-medium text-gray-700">End Date</label>
                        <input name="End_Date" type="date" class="mt-1 w-full border rounded p-2" value="{{ old('End_Date') }}">
                    </div>
                </div>
                <div class="flex justify-end space-x-3">
                    <a href="{{ route('promotions.index') }}" class="px-4 py-2 rounded border">Cancel</a>
                    <button class="px-4 py-2 rounded bg-pink-600 text-white">Create</button>
                </div>
            </form>
        </div>
    </div>
